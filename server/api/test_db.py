...
class TestDatabaseFunctions(unittest.TestCase):
    def setUp(self):
        os.environ["DB_PATH"] = "test_grinvites.db"
    ...
    def test_add_and_get_user(self):
        test_user = User(id='1', email='test@example.com', display_name='Test User', invite_times={}, theme='Google Calendar')
        add_user(test_user)
        ...
        self.assertEqual(user[4], 'Google Calendar')
